...
const Resumed = () => {
  return (
    <div className=" resumed d-flex flex-column h-100 bg-light">
                  ...
                  <div className="row align-items-center gx-5">
                    <div className="col text-center text-lg-start mb-4 mb-lg-0">
                      <div className="bg-light p-4 rounded-4">
                        ...
                        <div className="small text-muted">Beginner</div>
                        <div className="small text-muted">Lagos</div>
                      </div>
                    </div>
                    <div className="col-lg-8">
                      <div>
                        ...
                        all of the key administrative clinical data relevant to
                        that person's care under a particular provider. I’ve
                        worked on variety of prototype projects like travel
                        apps, shopping carts,note taking apps, currency
                        converters, weather apps etc. I’m passionate about
                        creating great user experiences and have a strong
                  ...
                  <div className="row align-items-center gx-5">
                    <div className="col text-center text-lg-start mb-4 mb-lg-0">
                      <div className="bg-light p-4 rounded-4">
                        ...
                        <div className="mb-2">
                          <div className="small fw-bolder">
                            Federal university of agricltural makurdi
                          </div>
                          <div className="small text-muted">Graduate</div>
                        </div>
                        <div className="fst-italic">
                          <div className="small text-muted">
                            civil engineering
                ...
                <div className="card-body p-5">
                  <div className="mb-5">
                    ...
                    <div className="row row-cols-1 row-cols-md-3">
                      <div className="col mb-4 mb-md-0"></div>
                      <div className="col">
                        <div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">
                  ...
                  <div className="mb-0">
                    <div className="d-flex align-items-center mb-4">
                      ...
                      <h3 className="fw-bolder mb-0">
                        <span className="text-primary d-inline">Languages</span>
                      </h3>
                    </div>
                    <div className="row row-cols-1 row-cols-md-3 mb-4">
                      <div className="col mb-4 mb-md-0">
