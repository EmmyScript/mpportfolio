        ...
        <div className="row">
              ...
              <div className="d-flex align-items-center">
                <div className="p-1">
                  ...
                  <p>
                    ...
                    shipped with the help of coding and details of the packages.
                  </p>
                  <a
          ...
          <div className="card h-100">
            <div className="card-body p-3">
                  ...
                  <p>
                    it help you to keep track of your shared expenses. by
                    creating group with friend. The bill sharing app
                    automatically calculates everyone share and distributes the
          ...
          <div className="card h-100">
            <div className="card-body p-3">
                  ...
                  <p>
                    static view of pizza list and with logic of disabled
                    sold-out{" "}
                  </p>
                  <a
